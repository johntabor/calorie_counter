...
class Settings extends Component {
    ...
    async fetchUser() {
        const url = process.env.REACT_APP_SERVER_URL + '/getUser'
        const req = {
            method: 'POST',
            headers: {
    ...
    saveSettings(values) {
        const url =  process.env.REACT_APP_SERVER_URL + '/updateUser'
        const req = {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
    ...
    render() {
        ...
        return (
            <Formik
                enableReinitialize
                initialValues={{
                    daily_caloric_goal: this.state.user.daily_caloric_goal,
                }}
